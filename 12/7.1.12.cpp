...
int main(int argc, char *argv[]) {
  ...
  arr[1] = new sotrudnik;arr[1]->FIO = "Eveleeva U.L";arr[1]->vozrast = 29;arr[1]->stazh = 3;arr[1]->dolzhnost = "Manager";
  ...
  arr[4] = new sotrudnik;arr[4]->FIO = "Gerovin I.O";arr[4]->vozrast = 41;arr[4]->stazh = 6;arr[4]->dolzhnost = "Engineer";
